...
class GNNEncoder(torch.nn.Module):
    def __init__(self, hidden_channels, out_channels, dropout=0.1):
        ...
        self.conv3 = SAGEConv(2*hidden_channels, out_channels)
...
class EdgeDecoder(torch.nn.Module):
    ...
    def forward(self, z_dict, edge_label_index):
        ...
        # z = attn_scores * z
        # print('\nencoder output for compound embedding:')
        # print(edge_label_index)
        # print(z_dict['compound'])
        # print(z_dict['compound'][edge_label_index[0]])
        # print('\nencoder output for protein embedding:')
        # print(z)
        # print('\n')
...
def train(model, optimizer, data):
    model.train()
    optimizer.zero_grad()
    # print(data.x_dict, data.edge_index_dict, data['compound', 'interacts_with', 'protein'].edge_label_index)
...
def runModel():
    data, train_data, val_data, test_data = load_and_create_graph('../testData/KIBA_compound_embeddings.csv', '../testData/KIBA_protein_embeddings.csv', '../testData/KIBA.csv')
    node_types = [("Compound",6),("protein",6)]
    ...
    # print(val_data)
    # print(val_data['compound', 'interacts_with', 'protein'].edge_label)
    # print(val_data['compound', 'interacts_with', 'protein'].edge_label_index)
    # print(test_data)
